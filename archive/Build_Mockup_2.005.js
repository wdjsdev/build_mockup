...
function container()
{
	...
	function getPrepressSubFolder(bmCode)
	{
		var localValid = true;
		...
		switch(bmCode)
		{
			...
			case "FD-622Y":
			case "FD-622":
				garment.prepressSubFolder = "BASKETBALL";
				break;
			...
			case "PS-5014":
			case "PS-5075W":
				garment.prepressSubFolder = "DIAMOND SPORTS";
				break;
			...
			case "FD-5411Y": 
			case "FD-5411": 
				garment.prepressSubFolder = "FOOTBALL";
				break;
			...
			case "FD-4004W":
			case "FD-4014W":
				garment.prepressSubFolder = "LACROSSE";
				break;
			...
			case "FD-858Y":
			case "FD-858":
				garment.prepressSubFolder = "SOCCER";
				break;
			...
			case "FD-872Y":
			case "FD-872":
				garment.prepressSubFolder = "SPIRITWEAR";
				break;
			...
			case "FD-3184W":
			case "FD-3185W":
				garment.prepressSubFolder = "VOLLEYBALL";


		}
		
		if(!garment.prepressSubFolder)
		{
	...
	if(valid)
	{
		log.h("Beginning execution of getPrepressSubFolder function.");
		if(getPrepressSubFolder(garment.bmCode))
		{
			log.l("getPrepressSubFolder function returned true. Set value of garment.prepressSubFolder to " + garment.prepressSubFolder);
		}
		else
		{
			valid = false;
