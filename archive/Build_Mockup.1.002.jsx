/*
	...
	Version History:
		...
		Version 1.002:
			...
			Currently this version opens the necessary template and applies basic fill colors
			to entire template file, excluding boombah logo and collar info.
...
function wrapper(){
	...
	function layerVis(bool){
		app.activeDocument.layers[0].layers["Prepress"].visible = bool;
	}
	...
	function changeTemplateColors(c1,c1Name,c2,c2Name,c3,c3Name,c4,c4Name,c5,c5Name,c6,c6Name,collar,collarName){
		...
		for(var a=0;a<arguments.length;a+=2){
			...
			if(curColor!=null){
				...
				app.activeDocument.defaultFillColor = swatches[curCName].color;
